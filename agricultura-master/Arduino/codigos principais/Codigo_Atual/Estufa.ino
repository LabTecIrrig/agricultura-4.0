...
#define DHTPIN 49                                       // Pino DATA do Sensor ligado na porta Digital 49
...
#define butUp    43                                     // Botão para selecionar tela acima no digital 43
#define butDown  41                                     // Botão para selecionar tela abaixo no digital 41
//#define butP     40                                     // Botão de ajuste mais no digital 40
//#define butM     42                                     // Botão de ajuste menos no digital 42
...
int rele_4 = 0;                                              // Variável do rele 4 da solenoide ligar para ligar o rele da 
    ...
    if (millis () - tempo_anterior_comparacao >= intervalo_comparacao)                                     // Verifica se passou o intervalo determinado para realizar as comparações
     {
        ...
        if (sensor_value[2] >= L0 && sensor_value[2] <= L1)
          {
        ...
        if (sensor_value[2] >= L0 && sensor_value[2] <= L3)
          {
        ...
        if (sensor_value[2] >= L0 && sensor_value[2] <= L4)
          {
