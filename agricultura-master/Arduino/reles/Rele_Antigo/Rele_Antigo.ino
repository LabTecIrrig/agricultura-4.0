...
#define butDown  40                                     // Botão para selecionar tela abaixo no digital 42
...
unsigned long intervalo_comparacao = 120000;               // Intervalo de tempo em MS para realizar a comparação entre os valores dos sensores e ativar ou não o sistema de irrigação
