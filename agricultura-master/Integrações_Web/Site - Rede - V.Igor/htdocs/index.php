<?php
  ...
  $queryumi = sprintf("SELECT * FROM umidade"); 

  $dados = mysql_query($query, $conn) or die(mysql_error());  
  $dadosumi = mysql_query($queryumi, $conn) or die(mysql_error());  

  $linha = mysql_fetch_assoc($dados);
  $linhaumi = mysql_fetch_assoc($dadosumi);

  $total = mysql_num_rows($dados);
  $totalumi= mysql_num_rows($dadosumi);   
?>
...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/js/bootstrap.bundle.min.js" integrity="sha384-A3rJD856KowSb7dwlZdYEkO39Gagi7vIsF0jrRAoQmDKKtQBHUuLZ9AsSv4jD4Xa" crossorigin="anonymous"></script>    <meta charset="UTF-8">
...
<body>
    <!-- Navbar Bootstrap -->
    <nav class="navbar navbar-expand-lg fixed-top " style="background-color:rgb(141, 209, 39); id=">
        <div class="container.py">
            ...
            <!-- BTN Sensores temperatura e umidade -->
            <button type="button" class="btn btn-success navbar-border-temp">
              ...
              <button type="button" class="btn btn-success navbar-border-solo">
            ...
            <button type="button" class="btn btn-success navbar-border-graf">
                ...
                <path d="M10 7a1 1 0 1 1 2 0v5a1 1 0 1 1-2 0V7Zm-6 4a1 1 0 1 1 2 0v1a1 1 0 1 1-2 0v-1Zm4-3a1 1 0 0 0-1 1v3a1 1 0 1 0 2 0V9a1 1 0 0 0-1-1Z"></path></svg>
                Gráficos
            </button>
              ...
              <button type="button" class="btn btn-success navbar-border-sens">
                ...
                <path d="M8.5 1.866a1 1 0 1 0-1 0V3h-2A4.5 4.5 0 0 0 1 7.5V8a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1v1a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-1a1 1 0 0 0 1-1V9a1 1 0 0 0-1-1v-.5A4.5 4.5 0 0 0 10.5 3h-2V1.866ZM14 7.5V13a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V7.5A3.5 3.5 0 0 1 5.5 4h5A3.5 3.5 0 0 1 14 7.5Z"></path></svg>
                Sensores
            </button>
